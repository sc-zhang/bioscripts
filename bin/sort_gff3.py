...
if __name__ == "__main__":
    if len(sys.argv) < 3:
        print("Usage: python "+sys.argv[0]+" <chr_prefix> <in_gff> <out_gff>")
        print("Notice: sort and rename id with in_gff")
        print("Example: python "+sys.argv[0]+" CB5 in.gff out.gff")
    else:
        chr_pre, in_gff, out_gff = sys.argv[1:]
        rename_id(chr_pre, in_gff, out_gff)
