...
- convert_collinearity_from_MCScanX_to_Circos.py is a script for converting collinearity file from MCScanX result to
...
- modify_geno_with_snp_mummer.py is a script for modifying columns in geno file with snp result generated by show-snps
  of mummer
...
- get_seq_with_bed.py is a script for extracting sequences from fasta file with bed file, the bed file can contain 4 or
...
- convert_anchorwave.py is a script for convert anchorwave maf file to a table file, which contains 7 columns: "Ref id,
...
- extract_fasta_with_bed.py is a script for extracting seq with bed file contain 5 colunms: "ID, start, end, direction,
