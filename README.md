...
13. extract_gene_from_gff.py is a script for extracting genes from gff3 file with gene id list and generating a bed
    file.
...
48. get_seq_with_bed.py is a script for extracting sequences from fasta file with bed file, the bed file can contain 4
    or
...
49. convert_anchorwave.py is a script for convert anchorwave maf file to a table file, which contains 7 columns: "Ref
    id,
...
50. extract_fasta_with_bed.py is a script for extracting seq with bed file contain 5 colunms: "ID, start, end,
    direction,
...
> ```bash
> conda create -n GoKegg -c conda-forge -c bioconda bioconductor-AnnotationForge bioconductor-clusterProfiler bioconductor-KEGGREST r-dplyr r-ggplot2 r-jsonlite r-optparse r-purrr r-RCurl r-stringr
> # or
> mamba create -n GoKegg -c conda-forge -c bioconda bioconductor-AnnotationForge bioconductor-clusterProfiler bioconductor-KEGGREST r-dplyr r-ggplot2 r-jsonlite r-optparse r-purrr r-RCurl r-stringr
> ```
>### Data preparation
>- Prepare eggnog result  
   > Drop lines start with "##", remove "#" at the beginning of line "#query ...", make sure the first line of
   annotation file is like below:
>```text
...
>	--plant_kegg=PLANT_KEGG
>		Pre-generated plant kegg db file
>	-h, --help
